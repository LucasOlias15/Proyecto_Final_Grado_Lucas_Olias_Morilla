...
export const Header = () => {
    ...
    return (
        <>
        <header className="navbar bg-base-100/80 backdrop-blur-md shadow-sm px-4 sticky top-0 z-100 h-20 transition-all duration-300 border-b border-base-200/50">

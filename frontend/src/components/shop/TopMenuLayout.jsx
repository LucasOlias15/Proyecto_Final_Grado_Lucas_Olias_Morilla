        ...
        <div className="p-6 max-w-7xl mx-auto flex flex-col md:flex-row gap-8">
          ...
          <ul className="menu w-full md:w-80 gap-2">
            ...
            <li>
              <Link href="/">
                <a
                  onClick={closeMenu}
                  className="text-lg font-medium hover:text-jungle_teal flex items-center gap-3 py-3"
                >
            ...
            {esDueño && (
              <li>
                <Link
                  href={`/panel-tienda/${usuario.id_comercio || usuario.id}`}
                >
                  <a
                    onClick={closeMenu}
                    className="text-lg font-medium hover:text-jungle_teal flex items-center gap-3 py-3"
            ...
            <li>
              <Link href="/soporte">
                <a
                  onClick={closeMenu}
                  className="opacity-70 text-lg font-medium hover:text-jungle_teal hover:opacity-100 transition-all flex items-center gap-3 py-3"
                >
          ...
          <div className="hidden md:flex flex-col flex-1 bg-base-200 rounded-2xl p-6 relative overflow-hidden">
            ...
            <div className="flex justify-between items-center mb-4 relative z-10">
              ...
              <Link href="/explorar?categoria=Todas">
                <a
                  onClick={closeMenu}
                  className="text-sm font-bold text-jungle_teal/70 hover:text-jungle_teal transition-colors"
                >
                  Ver todas &rarr;
                </a>
              </Link>
            ...
            <div className="grid grid-cols-2 gap-3 mb-6 relative z-10">
              ...
              <Link href="/explorar?categoria=Frutería">
                <a
                  onClick={closeMenu}
                  className="flex items-center gap-3 p-3 bg-base-100 rounded-xl hover:shadow-md hover:border-yellow-500 border border-transparent transition-all cursor-pointer group"
                >
              ...
              <Link href="/explorar?categoria=Panadería">
                <a
                  onClick={closeMenu}
                  className="flex items-center gap-3 p-3 bg-base-100 rounded-xl hover:shadow-md hover:border-orange-500 border border-transparent transition-all cursor-pointer group"
                >
              ...
              <Link href="/explorar?categoria=Carnicería">
                <a
                  onClick={closeMenu}
                  className="flex items-center gap-3 p-3 bg-base-100 rounded-xl hover:shadow-md hover:border-red-500 border border-transparent transition-all cursor-pointer group"
                >
              ...
              <Link href="/explorar?categoria=Bio">
                <a
                  onClick={closeMenu}
                  className="flex items-center gap-3 p-3 bg-base-100 rounded-xl hover:shadow-md hover:border-sea_green border border-transparent transition-all cursor-pointer group"
                >
              ...
              <Link href="/explorar?categoria=Artesanía y regalos">
                <a
                  onClick={closeMenu}
                  className="flex items-center gap-3 p-3 bg-base-100 rounded-xl hover:shadow-md hover:border-blue-500 border border-transparent transition-all cursor-pointer group"
                >
              ...
              <Link href="/explorar?categoria=Textiles y moda">
                <a
                  onClick={closeMenu}
                  className="flex items-center gap-3 p-3 bg-base-100 rounded-xl hover:shadow-md hover:border-purple-500 border border-transparent transition-all cursor-pointer group"
                >
              ...
              <Link href="/explorar?categoria=Pastelería">
                <a
                  onClick={closeMenu}
                  className="flex items-center gap-3 p-3 bg-base-100 rounded-xl hover:shadow-md hover:border-pink-500 border border-transparent transition-all cursor-pointer group"
                >
            ...
            <div className="mt-auto bg-linear-to-r from-jungle_teal to-sea_green p-4 rounded-xl text-white flex items-center justify-between relative z-10 shadow-lg">
              <div>
                ...
                <p className="text-xs md:text-sm opacity-90">
                  Únete a LocalMarkt gratis
                </p>
              </div>
              <button
                onClick={() => {
                  closeMenu();
                  document.getElementById("register_shop_modal").showModal();
                }}
                className="btn btn-sm bg-white text-jungle_teal border-none hover:bg-base-200 cursor-pointer"
              >
                Empezar
              </button>
            </div>
